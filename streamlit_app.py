...
# Convert the Snowpark dataframe into pandas data frame so we can use the LOC funtion
pd_df=my_dataframe.to_pandas()
# st.dataframe(pd_df)
# st.stop()

ingredients_list=st.multiselect('Choose 5 Fruits:',my_dataframe,max_selections=5)
